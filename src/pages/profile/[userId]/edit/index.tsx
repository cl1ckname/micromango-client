...
export default function EditProfile(props: ProfileEncoded) {
    ...
    return <div id="updateProductModal"
                ...
                <form>
                    <div className="grid gap-4 mb-4 sm:grid-cols-2">
                        <div>
                            ...
                            <input type="text" name="name" id="name" value={username} className={inputClasses}
                                   placeholder="input your username" onChange={handleUsername}/>
                        </div>
                        <div>
                            ...
                            <select id="category"
                                    ...
                                    value={bio.gender} onChange={handleGender}>
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" value={bio.status} className={inputClasses}
                                   placeholder="how its going?" onChange={handleStatus}/>
                        </div>
                    ...
                    <UploadImageWithPreview pic={props.picture} setFile={setPicture} file={picture} placeholder={"Upload profile picture"}/>
                    <UploadImageWithPreview pic={props.cover} setFile={setCover} file={cover} placeholder={"Upload profile cover"}/>
...
function UploadImageWithPreview(props: {
    ...
    let src: string = props.pic
    if (props.file) {
        src = URL.createObjectURL(props.file)
    }

    return <div className="flex justify-center mt-8 max-w-2xl rounded-lg shadow-xl bg-gray-50">
        <div className="m-4">
            <label className="inline-block mb-2 text-gray-500">{props.placeholder}</label>
            ...
            <input type="file" className="" onChange={handlePic} accept="image/png, image/jpg, image/webp, image/tiff"/>
        </div>
    </div>
}